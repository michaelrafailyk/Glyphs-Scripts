...
- Sort the characters by `uppercase` `lowercase` `figure` `punctuation` `other` `sc` `georgian` `armenian` categories.
- Sort the characters inside these categories alphabetically (except of Georgian and Armenian).
